//This test was succesfully conducted with the Flycat motors, and it is set for them, with Voltage, Pole pairs, set for it.
// When adjusted for GM4108 the test was unsuccessful with the specific parameters for the motor changed to 20V and 22 pole pairs.
...
void setup() {
  ...
  motor.voltage_limit = 12;   // [V]                   //According to the supply voltage, modify the value of voltage_limit here
  motor.velocity_limit = 40; // [rad/s]
  
  driver1.voltage_power_supply = 12;                  //Also modify the value of voltage_power_supply here
  driver1.init();
  motor1.linkDriver(&driver1);
  motor1.voltage_limit = 12;   // [V]                  //Also modify the value of voltage_limit here
